...
import insertProduct from '@salesforce/apex/BC_newProductController.insertProduct';
import uploadFile from '@salesforce/apex/BC_newProductController.uploadFile';
import getActiveProduct from '@salesforce/apex/BC_ProductController.getActiveProduct';
import { updateRecord } from 'lightning/uiRecordApi';

const columns = [
    // { label: 'Name', fieldName: 'Name', editable: true },
    { label: 'Car Model', fieldName: 'productName',  editable: true},
    { label: 'Car Brand', fieldName: 'productFamily', editable: true },
    { label: 'Image', fieldName: 'linkImage', type: 'image', editable: true },
    { label: 'Color', fieldName: 'color',  editable: true},
    { label: 'Price', fieldName: 'price', type: 'currency', editable: true }
];

export default class Bc_newProduct extends LightningElement {
    fileData = null;
    @track isOpen = false;
    @track vehicleValue = '';
    @track brandValue = '';
